...
// 픽셀 아트: 문자 매트릭스 → SVG rect(crispEdges) 렌더(px). PNG 미사용(다크모드·캐시·성능 유리).
    ...
    const PET_SPRITES = {
      ...
      cat_calico:{ walk:'assets/pets/cat/cat_calico/walk.png', frames:6, stills:true, scale:0.7 },
      ...
      cat_tuxedo:{ walk:'assets/pets/cat/cat_tuxedo/walk.png', frames:6, stills:true, scale:0.7 },
      cat_chaos:{ walk:'assets/pets/cat/cat_chaos/walk.png', frames:6, stills:true, scale:0.6 },
      ...
      cat_persian:{ walk:'assets/pets/cat/cat_persian/walk.png', frames:6, stills:true, scale:0.8 },
      tiger_white:{ walk:'assets/pets/tiger/tiger_white/walk.png', frames:6, stills:true, scale:5 },
      cat_russianblue:{ walk:'assets/pets/cat/cat_russianblue/walk.png', frames:6, stills:true, scale:0.8 },
      ...
      dog_samoyed:{ walk:'assets/pets/dog/dog_samoyed/walk.png', frames:6, stills:true, scale:1.8 },
      dog_husky:{ walk:'assets/pets/dog/dog_husky/walk.png', frames:6, stills:true, scale:1.8 },
      cat_mackerel2:{ walk:'assets/pets/cat/cat_mackerel2/walk.png', frames:6, stills:true, scale:0.7 },
      cat_calico2:{ walk:'assets/pets/cat/cat_calico2/walk.png', frames:6, stills:true, scale:0.7 },
      cat_white2:{ walk:'assets/pets/cat/cat_white2/walk.png', frames:6, stills:true, scale:0.7 },
      cat_cheese2:{ walk:'assets/pets/cat/cat_cheese2/walk.png', frames:6, stills:true, scale:0.7 },
      cat_tuxedo2:{ walk:'assets/pets/cat/cat_tuxedo2/walk.png', frames:6, stills:true, scale:0.7 },
      ...
      cat_russianblue2:{ walk:'assets/pets/cat/cat_russianblue2/walk.png', frames:6, stills:true, scale:0.8 },
      cat_scottishfold:{ walk:'assets/pets/cat/cat_scottishfold/walk.png', frames:6, stills:true, scale:0.8 },
      cat_black2:{ walk:'assets/pets/cat/cat_black2/walk.png', frames:6, stills:true, scale:0.7 },
      cat_seolleong:{ walk:'assets/pets/cat/cat_seolleong/walk.png', frames:6, stills:true, scale:0.7 },
      cat_persiangray:{ walk:'assets/pets/cat/cat_persiangray/walk.png', frames:6, stills:true, scale:0.7 },
      cat_mainecoon:{ walk:'assets/pets/cat/cat_mainecoon/walk.png', frames:6, stills:true, scale:1.5 },
      cat_americanshorthair:{ walk:'assets/pets/cat/cat_americanshorthair/walk.png', frames:6, stills:true, scale:0.8 },
      ...
      cat_munchkin:{ walk:'assets/pets/cat/cat_munchkin/walk.png', frames:6, stills:true, scale:0.8 },
      cat_norwegian:{ walk:'assets/pets/cat/cat_norwegian/walk.png', frames:6, stills:true, scale:0.8 },
      cat_bombay:{ walk:'assets/pets/cat/cat_bombay/walk.png', frames:6, stills:true, scale:0.8 },
      cat_abyssinian:{ walk:'assets/pets/cat/cat_abyssinian/walk.png', frames:6, stills:true, scale:0.8 },
      cat_sphynx:{ walk:'assets/pets/cat/cat_sphynx/walk.png', frames:6, stills:true, scale:0.8 },
      cat_british:{ walk:'assets/pets/cat/cat_british/walk.png', frames:6, stills:true, scale:0.8 },
      cat_bengalsnow:{ walk:'assets/pets/cat/cat_bengalsnow/walk.png', frames:6, stills:true, scale:0.8 },
      cat_longhaircalico:{ walk:'assets/pets/cat/cat_longhaircalico/walk.png', frames:6, stills:true, scale:0.7 },
      cat_tortie:{ walk:'assets/pets/cat/cat_tortie/walk.png', frames:6, stills:true, scale:0.8 },
      cat_siamesechoco:{ walk:'assets/pets/cat/cat_siamesechoco/walk.png', frames:6, stills:true, scale:0.8 },
      ...
      cat_mainecoonsmoke:{ walk:'assets/pets/cat/cat_mainecoonsmoke/walk.png', frames:6, stills:true, scale:1.2 },
      cat_mainecoonred:{ walk:'assets/pets/cat/cat_mainecoonred/walk.png', frames:6, stills:true, scale:1.2 },
      ...
      cat_singapura:{ walk:'assets/pets/cat/cat_singapura/walk.png', frames:6, stills:true, scale:0.5 },
    ...
    function copyRoomWall(src, dest){ gameRef().transaction(g=>{ g=normalizeGame(g); const rs=g.home.rooms; if(!rs[src]||!rs[dest]) return g;
        rs[dest].wallpaper=rs[src].wallpaper||'default'; rs[dest].floor=rs[src].floor||'default'; g.home.changedAt=new Date().toISOString(); return g;
    ...
    function clearRoom(idx){ closeRoomMenu();   // 모달을 먼저 닫아야 확인 시트가 보인다(모달 z-index가 더 위)
      confirmSheet('이 방의 가구·펫을 모두 비울까요? (가구는 인벤토리로 돌아가요)', ()=>{
        gameRef().transaction(g=>{ g=normalizeGame(g); const R=g.home.rooms[idx]; if(!R) return g;
          R.placed={}; R.wallPlaced={}; R.active=[]; R.poops=0; g.home.changedAt=new Date().toISOString(); return g;   // 바닥+벽 가구 모두 인벤토리로 회수
    ...
    function duplicateRoom(idx){ if(roomCount()>=MAX_ROOMS){ toast('방을 모두 열어서 더 복제할 수 없어요(최대 '+MAX_ROOMS+')'); return; } closeRoomMenu();
      gameRef().transaction(g=>{ g=normalizeGame(g); const rs=g.home.rooms; const src=rs&&rs[idx]; if(!src||rs.length>=MAX_ROOMS) return;
        ...
        rs.push({ name:nm, wallpaper:src.wallpaper||'default', emoji:src.emoji||'', placed:newPlaced, floor:src.floor||'default', wallPlaced:newWallPlaced, active:[], poops:0 });
