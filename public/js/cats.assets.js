...
// 픽셀 아트: 문자 매트릭스 → SVG rect(crispEdges) 렌더(px). PNG 미사용(다크모드·캐시·성능 유리).
    ...
    const M_CUSHION = [
      ...
      "..stXLHLLLLLLLLHLXts..",
      "..tXLLLLBXXXXBLLLLXt..",
      ".sXLLLBBXCCCCXBBLLCXs.",
      ".XLLBBXCCCCCCCCXBBLCX.",
      ".XLLBXCCCCCCCCCCXBLCX.",
      ".XLBXCCCCCCCCCCCCXBCX.",
      ".XLBXCCCCCCCCCCCCXBCX.",
      ".XLLBXCCCCCCCCCCXBLCX.",
      ".XLLBBXCCCCCCCCXBBLCX.",
      ".sXLLLBBXXXXXXBBLLCXs.",
      "..tXDLLLLLLLLLLLLDXt..",
      "..stXDDCCCCCCCCDDXts..",
      "....XXXXXXXXXXXXXX....",
      "......................",
    ...
    const M_LITTER = [
      "......................",
      "..kBBBBBBBBBBBBBBBBk..",
      ".kBeeeeeeeeeeeeeeeeBk.",
      ".BeWWvWWWvWWWvWWWvWeB.",
      ".BeWvWWvWWvWWvWWvWWeB.",
      ".BwWWvWwWvWWWvWwWvWeB.",
      ".BeWvWWWvWWvWWWvWWWeB.",
      ".BwWWwWvWWWvWwWvWWveB.",
      ".BeWvWWWvWwWWWvWWWWeB.",
      ".BwWWvWwWWWvWWWvWwWeB.",
      ".BeWvWWWvWWWvWwWWvWeB.",
      ".BwWWwWvWWvWWWvWWWWeB.",
      ".BeWvWWWvWWWvWWvWvWeB.",
    ...
    const M_FIREPLACE = [
      ...
      ".WHwHwHwHwHwHwHwHwHwW.",
      ".WwKkKmKkKmKkKmKkKmKW.",
      ".XKkKmKkKmKkKmKkKmKkX.",
      ".XmKkDDDDDDDDDDDDKkmX.",
      ".XKkDDDDDDDDDDDDDDmKX.",
      ".XmKDDDfDDDrDDfDDDkmX.",
      ".XKkDDFrfDDFrDrFfDDKX.",
      ".XmKDDrFFrFFFrFFrDDmX.",
      ".XKkDdFFFFFFFFFFFdDKX.",
      ".XmKDdFFFFFFFFFFFdDmX.",
      ".XKkDSLSLSLSLSLSLSDKX.",
      ".XmKkSLSLSLSLSLSLkKmX.",
      ".XKkKmKkKmKkKmKkKmKkX.",
      ".WWWWWWWWWWWWWWWWWWWW.",
      "..W..................W",
      "......................",
    ...
    const M_ROUNDBED = [
      ...
      "...WLHLLLLLLLLLLHLW...",
      "..WLLMMMMMMMMMMMMLLW..",
      ".WLLMmmmmmmmmmmmmMLLW.",
      ".WLMmMMMMMMMMMMMmMLW..",
      "WLLMmMMMMMMMMMMMmMLLW.",
      "WLMmMMMMMMMMMMMMMmMLW.",
      "WLLMmMMMMMMMMMMMmMLLW.",
      ".WLMmMMMMMMMMMMMmMLW..",
      ".WLLMmmmmmmmmmmmMLLW..",
      "..WLHLLLLLLLLLLHLLW...",
    ...
    const M_DONUTBED = [
      ...
      ".WLHLMmmmmmmmmmMLHLW..",
      ".WLLMmMMMMMMMMMmMLLW..",
      "WLHLMmMMMMMMMMMmMLHLW.",
      "WLLLMmMMMMMMMMMmMLLLW.",
      "WLHLMmMMMMMMMMMmMLHLW.",
      ".WLLMmMMMMMMMMMmMLLW..",
      ".WLHLMmmmmmmmmmMLHLW..",
      "..WLLLMMMMMMMMMLLLW...",
    ...
    const M_STRINGLIGHTS = [
      ...
      "...KKkk........................kkKK...",
      "..o..kKKkkk..............kkkKKk...o...",
      "..R......kkKKKkkkkkkKKKkk......o..B...",
      ".RRR..Y.......kkkkkk.......G...BBB....",
      ".RRR.YYY..o......o......o.GGG..BBB....",
      "..R..YYY..P......H.....o..GGG...B.....",
      ".....Y...PPP....HHH....oo..G..........",
      ".........PPP....HHH....oo.............",
      "......................................",
    ...
    const M_RUNNER = [
      ...
      "tt.BWWWWWWWWWWWWWWWB.tt",
      ".t.BWRRGGYYRRGGYYRWB.t.",
      "tt.BWGYRRGGYYRRGGYWB.tt",
      ".t.BWYWWWWWWWWWWWYWB.t.",
      "tt.BWRRGGYYRRGGYYRWB.tt",
      ".t.BWbWWWWWWWWWWWbWB.t.",
      "tt.BbbbbbbbbbbbbbbbB.tt",
      ".......................",
    ];
    const M_KOIPOND = [
      ".....................",
