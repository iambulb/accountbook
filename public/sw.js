...
const CACHE_VERSION = 'eggarden-v3.132.0';
const APP_SHELL = [
  './',
  './index.html',
  './css/styles.css',
  ...
  './assets/pets/cat_bengal/walk.png',
  './assets/pets/cat_bengal/south.png',
  './assets/pets/cat_bengal/north.png',
  './assets/pets/cat_bengal/east.png',
  './assets/pets/cat_bengal/west.png',
  './assets/pets/cat_fold/walk.png',
  './assets/pets/cat_fold/south.png',
  './assets/pets/cat_fold/north.png',
  './assets/pets/cat_fold/east.png',
  './assets/pets/cat_fold/west.png',
  './assets/pets/cat_bora/walk.png',
  './assets/pets/cat_bora/south.png',
  ...
  './assets/pets/cat_choco/east.png',
  './assets/pets/cat_choco/west.png',
  './assets/pets/cat_kitten/walk.png',
  ...
  './assets/pets/cat_pink/walk.png',
  './assets/pets/cat_pink/south.png',
  './assets/pets/cat_pink/north.png',
  './assets/pets/cat_pink/east.png',
  './assets/pets/cat_pink/west.png',
  './assets/pets/tiger_orange/walk.png',
  './assets/pets/tiger_orange/south.png',
  './assets/pets/tiger_orange/north.png',
  './assets/pets/tiger_orange/east.png',
  './assets/pets/tiger_orange/west.png',
  // @gen:end
];
