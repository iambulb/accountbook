...
- **알뜰샵 시트**(더보기 → 알뜰샵, 아이콘=은화): **홈**(방 뷰 + 걷는 고양이 + 배치 가구, 보유 고양이 탭해 최대 3마리 집에 내보내기) / **상점**(고양이 3종·가구 3종, 가구 수량 허용) / **배치**(12×12 격자, 캣타워=3×6·스크래처=2×2칸 점유·겹침 방지, 드래그로 이동, 배치된 가구 탭 시 회수/판매 메뉴) / **미션**(일일+주간).
